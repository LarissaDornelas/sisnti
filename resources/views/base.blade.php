...
<head>
  ...
  <title>SisNti |@yield('title')</title>
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/ufop.css') }}">
  @yield('morecss')
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('/') }}" class="logo">
      ...
      <span class="logo-mini"><img src="{{ asset('assets/img/icone-branco.png') }}"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{ asset('assets/img/icone-branco.png') }}"> SisNti</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="user user-menu">
            <a href="{{ route('logout') }}">
              ...
              <span class="hidden-xs"><i class="fa fa-sign-out"></i> Sair</span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header text-center">HELP DESK</li>
        @yield('sidebar')
        ...
        <li {!! Route::is('userTasks', 'taskDetail', 'userTasksFilter') ? "class='active'" : '' !!}><a href="{{ route('userTasks')}}"><i class="fa fa-list-alt"></i><span>Meus Chamados</span></a></li>
...
<!-- /.content-wrapper -->
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">NTI</a>.</strong> All rights
    reserved.
  </footer>
